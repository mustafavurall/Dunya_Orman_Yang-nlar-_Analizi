...
# CSV dosyasını okuma
df = pd.read_csv(r'C:\Users\1must\Documents\2022veriseti.csv')
...
filtered_df = df[df['initialdat'].dt.strftime('%Y-%m').eq('2022-01')]
...
m.save('Orman_Yangınları_Ocak_3Days.html')  # Haritayı HTML olarak kaydetme

# Haritayı tarayıcıda açma
import webbrowser
webbrowser.open('Orman_Yangınları_Ocak_3Days.html')