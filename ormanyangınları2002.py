...
# CSV dosyasını okuma
#df = pd.read_csv(r'C:\Users\1must\Desktop\Ormanyangınlarıveriseti.csv')
#print(df.head())
...
#m.save('Orman_Yangınları_Ocak_Days.html')  # Haritayı HTML olarak kaydetme

# Haritayı tarayıcıda açma
#import webbrowser
#webbrowser.open('Orman_Yangınları_Ocak_Days.html')
...
# CSV dosyasını okuma
df = pd.read_csv(r'C:\Users\1must\Documents\veriseti2002.csv')
...
filtered_df = df[df['initialdat'].dt.strftime('%Y-%m').eq('2002-01')]
